 ...
 * generated in the com.databasserne.loanbroker.webservices package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetBanks_QNAME = new QName("http://webservices.loanbroker.databasserne.com/", "getBanks");
    private final static QName _GetBanksResponse_QNAME = new QName("http://webservices.loanbroker.databasserne.com/", "getBanksResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.databasserne.loanbroker.webservices
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservices.loanbroker.databasserne.com/", name = "getBanks")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservices.loanbroker.databasserne.com/", name = "getBanksResponse")
